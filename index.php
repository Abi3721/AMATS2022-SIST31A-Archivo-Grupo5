...
<body id="container-page-index" background="grey">
    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/moda1.jpg" alt="moda1">
                <div class="carousel-caption">
                  Accesorios para Caballeros y Damas de todo tipo.
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/moda2.jpg" alt="moda2">
                <div class="carousel-caption">
                  Ropa casual Chaquetas, sacos, bufandas, etc.
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/moda3.jpg" alt="moda3">
                <div class="carousel-caption">
                    Zapatillas para Dama de vestir o casuales.
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/moda4.jpg" alt="moda4">
                <div class="carousel-caption">
                    Zapatos para Caballero para todo momento.
                </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">Gomez Fashion</span> en un sencillo formulario para poder completar tus pedidos</p>
                        <p><a href="registration.php" class="btn btn-info btn-raised btn-block">Registrarse</a></p>   
                   </article>
                </div>

                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/colorblok.jpg" alt="color blok" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
